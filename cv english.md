...
* ## November 2018 — July 2019
  ...
  # SAP EMEA
  #### Izhevsk, www.sap.ru
  Onbording is a system for simplifying employment and personnel management, simplifying document flow, including preparation of tax declarations.  
  __Role__: Junior Developer  
  __Responsibilities__: development, support and testing of SuccessFactors Onbording.  
    *  __Involved in the development of new and updating old Wizard panels with multiple inputs__:   jQuery, JavaScript, HTML, CSS, ASP.NET, Visual Basic.  
    *  __Creation and update of layouts__: JavaScript, HTML, CSS, ASP.NET Conrols.  
    *  __Correction and creation of PDF mapping__: XML, PDF, ASP.NET Conrols.  
    *  __Tracking their correct display in the system__: XML, SQL Server.  
    *  __Version control system__: GIT.  
  All work was done in a SCRUM team with foreign colleagues.  
  __Project management system__: Jira.  
  Every second sprint ended with regression testing.  
  __Platform__: SuccessFactors Onbording, ASP.NET, Visual Basic, SQL Server.  
  Have a recommendation's letter.
